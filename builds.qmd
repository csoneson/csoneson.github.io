...
get_bioc_runiverse_check <- function(y) {
    if (y$section %in% c("bioc")) {
        paste0(
            '<a href="https://bioc.r-universe.dev/', y$package, '#checktable">',
            '<img src="https://bioc.r-universe.dev/', y$package,
...
make_df <- function(yml) {
    do.call(bind_rows, lapply(yml, function(y) {
        data.frame(
            ...
            `Bioc r-universe` = get_bioc_runiverse_check(y),
