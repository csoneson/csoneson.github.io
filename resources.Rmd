...
<center>
[![](stickers/alevinQC.png){width=3cm}](http://bioconductor.org/packages/alevinQC/)[![](stickers/ARMOR.png){width=3cm}](https://github.com/csoneson/ARMOR)[![](stickers/countsimQC.png){width=3cm}](https://bioconductor.org/packages/countsimQC/)[![](stickers/eisaR.png){width=3cm}](http://bioconductor.org/packages/eisaR/)[![](stickers/emm_logo.png){width=3cm}](http://bioconductor.org/packages/ExploreModelMatrix/)[![](stickers/iCOBRA.png){width=3cm}](http://bioconductor.org/packages/iCOBRA/)[![](stickers/iSEE.png){width=3cm}](http://bioconductor.org/packages/iSEE/)[![](stickers/velociraptor_sticker.png){width=3cm}](https://github.com/kevinrue/velociraptor)
</center>
...
- `r badger::badge_custom(x = "", y = "velociraptor", color = "red", url = "https://github.com/kevinrue/velociraptor")`
