...
pmid_remove <- c("31925006")

## PubMed IDs to add
pmid_add <- c("27309738", "26615188", "25057166")

## bioRxiv dois
biorxiv_dois <- c("10.1101/713412", 
                  "10.1101/2020.03.13.990069", 
                  "10.1101/2020.06.08.140608")
...
biorxiv_software <- rbind(
  ...
  c(doi = "10.1101/713412", software = "https://bioconductor.org/packages/muscat/"),
  c(doi = "10.1101/2020.03.13.990069", software = "https://bioconductor.org/packages/eisaR/")
)
...
#   title = c("ExploreModelMatrix: Interactive exploration for improved understanding of design matrices and linear models in R"),
#   pubdate = c("Posted June 4, 2020."),
#   pubyear = c("Preprints"),
#   journal = c("F1000Research"),
#   authors = c("Charlotte Soneson, Federico Marini, Florian Geier, Michael I Love, Michael B Stadler"),
#   volume = c(9),
#   issue = c(512),
#   pages = c(""),
#   doi = c("10.12688/f1000research.24187.1"),
#   pmid = c(""),
#   elocationid = c("")
# )
