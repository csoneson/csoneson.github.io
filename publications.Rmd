...
f1000_preprints <- data.frame(
  title = c("iSEE: Interactive SummarizedExperiment Explorer"),
  pubdate = c("Posted June 14, 2018."),
  pubyear = c("Preprints"),
  journal = c("F1000Research"),
  authors = c("Kevin Rue-Albrecht, Federico Marini, Charlotte Soneson, Aaron TL Lun"),
  volume = c(7),
  issue = c(741),
  pages = c(""),
  doi = c("10.12688/f1000research.14966.1"),
  pmid = c(""),
  elocationid = c("")
)
```
