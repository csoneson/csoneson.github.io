...
PubMed-indexed preprints are indicated with a title in purple. 
...
## bioRxiv dois
biorxiv_dois <- c("10.1101/2023.04.20.537632", 
                  "10.1101/2022.10.25.513674",
                  "10.1101/2022.09.22.508982", 
...
biorxiv_github <- rbind(
  ...
  c(doi = "10.1101/2022.10.25.513674", github = "https://github.com/fmicompbio/mutscan_manuscript_2022")
)
...
biorxiv_software <- rbind(
  ...
  c(doi = "10.1101/2022.10.25.513674", software = "https://github.com/fmicompbio/mutscan")
)
...
make_text_purple <- function(text) {
    sprintf('<span style="color:purple;">%s</span>', text)
}
```
