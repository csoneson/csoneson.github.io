...
suppressPackageStartupMessages({
  ...
  library(scholar)
  library(lubridate)
  library(medrxivr) # ropensci/medrxivr
})
```
...
pmid_remove <- c("31925006", "33877351", "37090609", 
                 "36711921", "37645841",
                 "38826347", "40160449", "41040322")
...
## OSF IDs
# osf_ids <- c()
# osf_ids <- c("10.31219/osf.io/wxjky")
...
pmid_github <- rbind(
  ...
  c(pmid = "42055004", github = "https://github.com/fmicompbio/IVMC-protocol")
)
...
pmid_preprints <- rbind(
  ...
  c(pmid = "40907933", preprint = "https://doi.org/10.1101/2023.04.12.536513"),
  c(pmid = "41231865", preprint = "https://arxiv.org/abs/2409.15472"),
  c(pmid = "42055004", preprint = "https://doi.org/10.1101/2025.07.03.663000"),
  c(pmid = "42321490", preprint = "https://doi.org/10.1101/2025.09.26.678732")
)
...
# OSF preprints
osf <- data.frame(
    title = c("Bioconductor Spatial Data and Image Analysis Hackathon"),
    pubdate = c("Posted June 14, 2026."),
    pubyear = c("Preprints"),
    journal = c("BioHackrXiv"),
    authors = c("Helena Crowell, Luca Marconato, Ilaria Billato, Matteo Calgaro, Robert Castelo, Riccardo Ceccaroni, Carissa Chen, Patrick Danaher, Sean Davis, Martin Emons, Gabriel Grajeda, Hugo Gruson, Samuel Gunz, Juan Henao, Rafael Irizarry, Sviatoslav Kharuk, Daria Lazic, Artur Manukyan, Pere Moles-Seró, Elizabeth Purdom, Dario Righelli, Gabriele Sales, Mike L. Smith, Charlotte Soneson, Michael B. Stadler, Wolfgang Huber, Davide Risso"),
    volume = c(""), 
    issue = c(""),
    pages = c(""),
    doi = c("10.37044/osf.io/9ej32_v1"),
    pmid = c(""),
    elocationid = c("")
)
```
...
osf <- do.call(rbind, lapply(osf_ids, function(id) {
    html <- read_html_live(paste0("https://doi.org/", id))
    Sys.sleep(6)
...
```{r sort-biorxiv}
# sort preprints by date
biorxiv <- biorxiv[
    order(mdy(sub("\\.$", "", sub("Posted ", "", biorxiv$pubdate))), 
          decreasing = TRUE), 
]
```
